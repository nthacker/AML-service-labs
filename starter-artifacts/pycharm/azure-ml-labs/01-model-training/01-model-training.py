...
df = pd.read_csv('./01-model-training/data/UsedCars_Clean.csv', delimiter=',')
print(df)
...
ds.upload(src_dir='./01-model-training/data', target_path='used_cars', overwrite=True, show_progress=True)
...
est_config = Estimator(source_directory='./01-model-training/training',
